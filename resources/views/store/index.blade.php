...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce Our Stores Page | Unify - Responsive Website Template</title>
      ...
      <div class="container g-py-100">
        <div class="row">
          <div class="col-md-6 g-brd-right--md g-brd-bottom--md g-brd-gray-light-v4 g-pr-40--md">
            <!-- Store Info -->
            <h2 class="h4 mb-3">Canada</h2>

            <div class="row">
              <div class="col g-mb-30">
                <h3 class="h6 g-color-gray-dark-v3">Details:</h3>
                <address class="g-color-text mb-3">
                  972 Sylvan Street South<br>Angelina, NL S0B2V9
                </address>
                <ul class="list-unstyled g-color-text">
                  <li class="g-py-1">Tel: (0161) 347 8854</li>
                  <li class="g-py-1">Email: <a href="#">unify.ca@store.com</a></li>
                  <li class="g-py-1">Website: <a href="#">unify.ca/store</a></li>
                </ul>
              </div>
              <div class="col g-mb-30">
                <h3 class="h6 g-color-gray-dark-v3">Business Hours:</h3>
                <span class="d-block g-color-text mb-4">Mon - Sat: 9.30AM - 06.00PM</span>
                <img class="img-fluid" src="assets/img-temp/300x100/img1.jpg" alt="Image Description">
              </div>
            </div>
            <!-- End Store Info -->
          </div>
          ...
          <div class="col-md-6 g-brd-bottom--md g-brd-gray-light-v4 g-pl-40--md">
            <!-- Store Info -->
            <h2 class="h4 mb-3">Great Britain</h2>

            <div class="row">
              <div class="col g-mb-30">
                <h3 class="h6 g-color-gray-dark-v3">Details:</h3>
                <address class="g-color-text">
                  470 Lucy Forks,<br>Patriciafurt, YC7B 3UT
                </address>
                <ul class="list-unstyled g-color-text">
                  <li class="g-py-1">Tel: (0117) 900 9463</li>
                  <li class="g-py-1">Email: <a href="#">unify.co@store.com</a></li>
                  <li class="g-py-1">Website: <a href="#">unify.co/store</a></li>
                </ul>
              </div>
              <div class="col g-mb-30">
                <h3 class="h6 g-color-gray-dark-v3">Business Hours:</h3>
                <span class="d-block g-color-text mb-4">Mon - Sat: 9.30AM - 06.00PM</span>
                <img class="img-fluid" src="assets/img-temp/300x100/img2.jpg" alt="Image Description">
              </div>
            </div>
            <!-- End Store Info -->
          </div>
        ...
        <div class="row">
          <div class="col-md-6 g-brd-right--md g-brd-gray-light-v4 g-pt-40 g-pr-40--md">
            <!-- Store Info -->
            <h2 class="h4 mb-3">United States</h2>

            <div class="row">
              <div class="col g-mb-30">
                <h3 class="h6 g-color-gray-dark-v3">Details:</h3>
                <address class="g-color-text">
                  728 Dooley Branch,<br>Beckershire, LA 63598-2909
                </address>
                <ul class="list-unstyled g-color-text">
                  <li class="g-py-1">Tel: (364) 106-7572</li>
                  <li class="g-py-1">Email: <a href="#">unify.us@store.com</a></li>
                  <li class="g-py-1">Website: <a href="#">unify.us/store</a></li>
                </ul>
              </div>
              <div class="col g-mb-30">
                <h3 class="h6 g-color-gray-dark-v3">Business Hours:</h3>
                <span class="d-block g-color-text mb-4">Mon - Sat: 9.30AM - 06.00PM</span>
                <img class="img-fluid" src="assets/img-temp/300x100/img3.jpg" alt="Image Description">
              </div>
            </div>
            <!-- End Store Info -->
          </div>
          ...
          <div class="col-md-6 g-pt-40 g-pl-40--md">
            <!-- Store Info -->
            <h2 class="h4 mb-3">France</h2>

            <div class="row">
              <div class="col g-mb-30--md">
                <h3 class="h6 g-color-gray-dark-v3">Details:</h3>
                <address class="g-color-text">
                  2, Avenue Mace,<br>35804 Gauthier
                </address>
                <ul class="list-unstyled g-color-text">
                  <li class="g-py-1">Tel: (605) 230-5253</li>
                  <li class="g-py-1">Email: <a href="#">unify.fr@store.com</a></li>
                  <li class="g-py-1">Website: <a href="#">unify.fr/store</a></li>
                </ul>
              </div>
              <div class="col g-mb-30--md">
                <h3 class="h6 g-color-gray-dark-v3">Business Hours:</h3>
                <span class="d-block g-color-text mb-4">Mon - Sat: 9.30AM - 06.00PM</span>
                <img class="img-fluid" src="assets/img-temp/300x100/img4.jpg" alt="Image Description">
              </div>
            </div>
            <!-- End Store Info -->
          </div>
