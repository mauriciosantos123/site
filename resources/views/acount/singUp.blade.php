          ...
          <div class="col-lg-5 order-lg-2 g-mb-80">
              ...
              <form class="g-py-35">
                <div class="row">
                  <div class="col g-mb-20">
                    <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 rounded g-py-15 g-px-15" type="text" placeholder="Nome">
                  </div>
                ...
                <div class="form-group g-mb-20">
                  <select class="js-custom-select u-select-v1 g-brd-gray-light-v3 g-color-gray-dark-v5 rounded g-py-12" style="width: 100%;"
                    ...
                    <option></option>
                    <option value="First Option">Masculino</option>
                    <option value="Second Option">Feiminino</option>
                    <option value="Third Option">Outros</option>
                  </select>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col g-mb-20">
                    <input type="date" class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 rounded g-py-15 g-px-15" type="text" placeholder="Data Aniversario">
                  </div>
                ...
                <div class="g-mb-20">
                  <input type="number" class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 rounded g-py-15 g-px-15" type="text" placeholder="Telefone">
                </div>
                ...
                <div class="g-mb-20">
                  <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 rounded g-py-15 g-px-15" type="text" placeholder="Senha">
                </div>
            ...
            <div class="text-center">
              <p class="g-color-gray-dark-v5 mb-0">Ja tem cadastro ?
                <a class="g-font-weight-600" href="page-login-1.html">Entrar</a></p>
            </div>
          </div>
