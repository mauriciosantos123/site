        ...
        <div class="row justify-content-between">
          <div class="col-md-6 col-lg-5 order-lg-2 g-mb-80">
            <div class="g-brd-around g-brd-gray-light-v3 g-bg-white rounded g-px-30 g-py-50 mb-4">
              ...
              <!-- Form -->
              <form class="g-py-15" action="{{route('account.login')}}">
                <div class="mb-4">
                  <div class="input-group g-rounded-left-3">
                    ...
                    <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-rounded-left-0 g-rounded-right-3 g-py-15 g-px-15" type="email" placeholder="Email">
                  </div>
                </div>
                ...
                <div class="mb-4">
                  <div class="input-group g-rounded-left-3 mb-4">
                    ...
                    <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-rounded-left-0 g-rounded-right-3 g-py-15 g-px-15" type="password" placeholder="Senha">
                  </div>
                </div>
            ...
            <div class="text-center">
              <p class="g-color-gray-dark-v5 mb-0">Ainda não tem conta?
                <a class="g-font-weight-600" href="{{route('account.signup')}}">Cadastre-se </a></p>
            </div>
          </div>
